...
import com.abcvoipsip.api.SipUri.ParsedSipContactInfos;
import com.abcvoipsip.service.SipNotifications;
import com.abcvoipsip.service.SipService.SameThreadException;
import com.abcvoipsip.service.SipService.SipRunnable;
import com.abcvoipsip.utils.CallLogHelper;
import com.abcvoipsip.utils.Log;
import com.abcvoipsip.utils.Threading;
...
*/			
	...
	public void initService(PjSipService srv) {
		...
		if (eventLock == null) {
			...
			eventLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.abcvoipsip.inEventLock");
			eventLock.setReferenceCounted(true);

		}
		if(incomingCallLock == null) {
            PowerManager pman = (PowerManager) pjService.service.getSystemService(Context.POWER_SERVICE);
            incomingCallLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.abcvoipsip.incomingCallLock");
