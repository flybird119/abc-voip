...
import com.abcvoipsip.service.MediaManager;
import com.abcvoipsip.service.SipService;
import com.abcvoipsip.service.SipService.SameThreadException;
import com.abcvoipsip.service.SipService.ToCall;
import com.abcvoipsip.utils.ExtraPlugins;
...
import com.abcvoipsip.utils.TimerWrapper;
import com.abcvoipsip.utils.ExtraPlugins.DynCodecInfos;
import com.abcvoipsip.wizards.WizardUtils;
                ...
                if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)){
                    ...
                    if(videoPlugins.size() > 0) {
                        ...
                        // Capture
                        {
                            ...
                            try {
                                ComponentName cmp = new ComponentName("com.abcvoipsip.plugins.video", "com.abcvoipsip.plugins.video.CaptureReceiver");
