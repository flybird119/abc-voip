...
package com.abcvoipsip.api;

import com.abcvoipsip.api.ISipService;
...
public final class SipManager {
     ...
     */
    public static final String INTENT_SIP_CONFIGURATION = "com.abcvoipsip.service.SipConfiguration";
    /**
     * Bind sip service to control calls.
     * 
     * @see ISipService
     */
    public static final String INTENT_SIP_SERVICE = "com.abcvoipsip.service.SipService";
    /**
     ...
     * </p>
     */
    public static final String INTENT_SIP_ACCOUNT_ACTIVATE = "com.abcvoipsip.accounts.activate";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_UI = "com.abcvoipsip.phone.action.INCALL";
    /**
     * Action launched when the status icon clicked.<br/>
     * Should raise the dialer.
     */
    public static final String ACTION_SIP_DIALER = "com.abcvoipsip.phone.action.DIALER";
    /**
     * Action launched when a missed call notification entry is clicked.<br/>
     * Should raise call logs list.
     */
    public static final String ACTION_SIP_CALLLOG = "com.abcvoipsip.phone.action.CALLLOG";
    /**
     * Action launched when a sip message notification entry is clicked.<br/>
     * Should raise the sip message list.
     */
    public static final String ACTION_SIP_MESSAGES = "com.abcvoipsip.phone.action.MESSAGES";
     ...
     * </p>
     */
    public static final String ACTION_SIP_CALL_CHANGED = "com.abcvoipsip.service.CALL_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_ACCOUNT_CHANGED = "com.abcvoipsip.service.ACCOUNT_CHANGED";
    /**
     ...
     * </p>
     */
    public static final String ACTION_SIP_REGISTRATION_CHANGED = "com.abcvoipsip.service.REGISTRATION_CHANGED";
    /**
     * Broadcast sent when the state of device media has been changed.
     */
    public static final String ACTION_SIP_MEDIA_CHANGED = "com.abcvoipsip.service.MEDIA_CHANGED";
    /**
     * Broadcast sent when a ZRTP SAS
     */
    public static final String ACTION_ZRTP_SHOW_SAS = "com.abcvoipsip.service.SHOW_SAS";

    public static final String ACTION_SIP_MESSAGE_RECEIVED = "com.abcvoipsip.service.MESSAGE_RECEIVED";

    // REGISTERED BROADCASTS
    /**
     * Broadcast to send when the sip service can be stopped.
     */
    public static final String ACTION_SIP_CAN_BE_STOPPED = "com.abcvoipsip.service.ACTION_SIP_CAN_BE_STOPPED";
    /**
     * Broadcast to send when the sip service should be restarted.
     */
    public static final String ACTION_SIP_REQUEST_RESTART = "com.abcvoipsip.service.ACTION_SIP_REQUEST_RESTART";

    // PLUGINS BROADCASTS
    /**
     * Plugin action for themes.
     */
    public static final String ACTION_GET_DRAWABLES = "com.abcvoipsip.themes.GET_DRAWABLES";
    /**
     * Plugin action for call handlers.
     */
    public static final String ACTION_GET_PHONE_HANDLERS = "com.abcvoipsip.phone.action.HANDLE_CALL";
    /**
     * Plugin action for audio codec.
     */
    public static final String ACTION_GET_EXTRA_CODECS = "com.abcvoipsip.codecs.action.REGISTER_CODEC";
    /**
     * Plugin action for video.
     */
    public static final String ACTION_GET_VIDEO_PLUGIN = "com.abcvoipsip.plugins.action.REGISTER_VIDEO";
    /**
     ...
     */
    public static final String AUTHORITY = "com.abcvoipsip.db";
    /**
