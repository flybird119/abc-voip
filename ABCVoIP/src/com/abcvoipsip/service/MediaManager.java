...
import com.abcvoipsip.service.SipService.SameThreadException;
import com.abcvoipsip.service.SipService.SipRunnable;
import com.abcvoipsip.utils.Compatibility;
import com.abcvoipsip.utils.Log;
import com.abcvoipsip.utils.Ringer;
import com.abcvoipsip.utils.accessibility.AccessibilityWrapper;
import com.abcvoipsip.utils.audio.AudioFocusWrapper;
import com.abcvoipsip.utils.bluetooth.BluetoothWrapper;
...
public class MediaManager {
	...
	private synchronized void actualSetAudioInCall() {
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.abcvoipsip.onIncomingCall.SCREEN");
		...
		if(cpuLock == null) {
			PowerManager pm = (PowerManager) service.getSystemService(Context.POWER_SERVICE);
			cpuLock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.abcvoipsip.onIncomingCall.CPU");
