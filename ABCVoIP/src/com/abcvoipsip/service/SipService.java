...
import com.abcvoipsip.api.MediaState;
import com.abcvoipsip.api.SipCallSession;
import com.abcvoipsip.api.SipConfigManager;
...
import com.abcvoipsip.api.SipManager.PresenceStatus;
import com.abcvoipsip.db.DBAdapter;
import com.abcvoipsip.db.DBProvider;
import com.abcvoipsip.models.Filter;
import com.abcvoipsip.pjsip.PjSipCalls;
import com.abcvoipsip.pjsip.PjSipService;
import com.abcvoipsip.pjsip.UAStateReceiver;
import com.abcvoipsip.service.receiver.DynamicReceiver4;
import com.abcvoipsip.service.receiver.DynamicReceiver5;
import com.abcvoipsip.ui.InCallMediaControl;
import com.abcvoipsip.utils.Compatibility;
import com.abcvoipsip.utils.CustomDistribution;
import com.abcvoipsip.utils.Log;
import com.abcvoipsip.utils.PhoneCapabilityTester;
import com.abcvoipsip.utils.PreferencesProviderWrapper;
import com.abcvoipsip.api.ISipConfiguration;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
        ...
        pm.setComponentEnabledSetting(new ComponentName(selfPkg, "com.abcvoipsip.ui.PrivilegedOutgoingCallBroadcaster"), enableState, PackageManager.DONT_KILL_APP);
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.abcvoipsip.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.abcvoipsip.SipService");
