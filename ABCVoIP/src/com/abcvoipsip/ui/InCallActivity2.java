...
import com.abcvoipsip.service.SipService;
import com.abcvoipsip.utils.CallsUtils;
import com.abcvoipsip.utils.Compatibility;
import com.abcvoipsip.utils.CustomDistribution;
import com.abcvoipsip.utils.DialingFeedback;
import com.abcvoipsip.utils.Log;
import com.abcvoipsip.utils.PreferencesProviderWrapper;
import com.abcvoipsip.utils.Theme;
import com.abcvoipsip.widgets.Dialpad;
import com.abcvoipsip.widgets.InCallControls2;
import com.abcvoipsip.widgets.InCallInfo2;
import com.abcvoipsip.widgets.ScreenLocker;
import com.abcvoipsip.widgets.Dialpad.OnDialKeyListener;
import com.abcvoipsip.widgets.InCallControls2.OnTriggerListener;
...
public class InCallActivity2 extends Activity implements OnTriggerListener, OnDialKeyListener,
        SensorEventListener, com.abcvoipsip.widgets.SlidingTab.OnTriggerListener {
    ...
    protected void onStart() {
        ...
        if (keyguardManager == null) {
            ...
            keyguardLock = keyguardManager.newKeyguardLock("com.abcvoipsip.inCallKeyguard");
        }
